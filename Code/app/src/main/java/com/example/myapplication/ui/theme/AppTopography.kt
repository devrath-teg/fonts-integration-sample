...
object AppTopography {

    object SansOsF {

        object FontSansOsF {
            val bold: Font = Font(resId = R.font.sans_osf_bold)
            val boldItalic: Font = Font(resId = R.font.sans_osf_bold_italic)
            val extraBold: Font = Font(resId = R.font.sans_osf_extra_bold)
            val extraBoldItalic: Font = Font(resId = R.font.sans_osf_extra_bold_italic)
            val light: Font = Font(resId = R.font.sans_osf_light)
            val lightItalic: Font = Font(resId = R.font.sans_osf_light_italic)
            val regular: Font = Font(resId = R.font.sans_osf_regular)
            val regularItalic: Font = Font(resId = R.font.sans_osf_regular_italic)
            val semiBold: Font = Font(resId = R.font.sans_osf_semi_bold)
            val semiBoldItalic: Font = Font(resId = R.font.sans_osf_semi_bold_italic)
        }
